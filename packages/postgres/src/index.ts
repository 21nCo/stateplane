import type { RecordRef, Revision, SpaceId } from '@stateplane/contracts';
...
export type AuthorityReceiptLookup = { state: 'pending' } | { state: 'committed'; receipt: AuthorityReceiptWrite };
...
// receipt's original ref before comparing its digest or replaying its response.
